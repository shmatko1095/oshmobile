...
void main() {
  test('energy metric uses sum semantics and kWh scaling', () {
    final energyDefinition =
        TelemetryHistoryMetricCatalog.powerMeterDefinitions.firstWhere(
      (definition) =>
    ...
    expect(
      energyDefinition.displayMode,
      TelemetryHistoryMetricDisplayMode.energyDelta,
    );
  });
}

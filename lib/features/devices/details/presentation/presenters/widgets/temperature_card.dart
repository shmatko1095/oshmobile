...
//
//   // State binds
//   final Signal currentBind; // e.g. 'sensor.temperature'
//   final Signal targetBind; // e.g. 'setting.target_temperature'
//   final Signal? nextValueBind; // e.g. 'schedule.next_target_temperature' (optional)
//   final Signal? nextTimeBind; // e.g. 'schedule.next_time' (optional)
//   final Signal? heaterEnabledBind; // e.g. 'status.heater_enabled' (optional)
//   final Signal? humidityBind; // e.g. 'sensor.humidity'
//
...
//     final num? current = context.select<DeviceStateCubit, num?>((c) => _asNum(c.state.get(currentBind)));
//     final num? target = context.select<DeviceStateCubit, num?>((c) => _asNum(c.state.get(targetBind)));
//
//     final num? nextVal = nextValueBind == null
//         ? null
//         : context.select<DeviceStateCubit, num?>((c) => _asNum(c.state.get(nextValueBind!)));
//
//     final dynamic rawNextTime =
//         nextTimeBind == null ? null : context.select<DeviceStateCubit, dynamic>((c) => c.state.get(nextTimeBind!));
//
...
//         humidityBind == null ? null : context.select<DeviceStateCubit, dynamic>((c) => c.state.get(humidityBind!));
//

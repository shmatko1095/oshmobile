...
JsonRpcException mapJsonRpcError(int code, String message, {String? domain}) {
  switch (code) {
    ...
    case JsonRpcErrorCodes.unsupportedSchema:
      return JsonRpcUnsupportedSchema(
